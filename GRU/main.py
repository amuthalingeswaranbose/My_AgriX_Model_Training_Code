...
from cropclassifier import GRUModel
...
if __name__ == "__main__":
    ...
    model_path = os.path.join(model_dir, 'GRU_old_cotton_layers2_lr0.01_epoch400.pth')    
    
    # dataset path 
    #db_csvpath = os.path.join("/home/ubuntu/Amuthan_Agrix_Codes/Interns_model_performance_analysis/dataset","cotton_consolidated.csv")
