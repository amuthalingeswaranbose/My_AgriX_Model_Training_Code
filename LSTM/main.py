...
if __name__ == "__main__":
    ...
    model_dir = "/Users/Lenovo/Downloads/cropProject/ModelTraining_Expts/Test"
    #os.makedirs(model_dir, exist_ok=True)
    model_path = os.path.join(model_dir, 'maize_savedmodel.pth')
    
    db_csvpath = os.path.join("C:/Users/Lenovo/Downloads/cropProject/Data/consolidated","maize_consolidated.csv")
